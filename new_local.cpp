                    ...
                    const llvm::APInt costanteSub)
{
    ...
    // Itera le istruzioni partendo dalla sottrazione e arriva fino all'inizio
    // (primaIstruzione)               // TO-DO : migliorare ciclo
    ...
    do
    {
        ...
        // Controllo se il value dell'operazione che sto analizzando è uguale al
        // value del sottrazione          //TO-DO : trovare un altro metodo per
        // confrontare
